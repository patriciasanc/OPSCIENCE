#!/usr/bin/python
# -*- coding: UTF-8 -*-
#Este script permite ahorrar tiempo guardando en formato Pickle las características y los clasificadores.
#Estos documentos entrenados se guardan en un directorio llamado "pickled_algos" para poder ser usados desde el módulo de análisis de sentimientos.
...
# El Corpus consta de 10.000 casos.
